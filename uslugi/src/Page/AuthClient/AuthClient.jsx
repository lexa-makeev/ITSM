...
function AuthClient() {
  ...
  const [valueTelReg, setValueTelReg] = useState("");
  ...
  function regSubmit(e) {
    ...
    formData.append("tel_reg", valueTelReg);
    axios({
      method: "post",
        ...
        {isReg === true ? (
          <>
            <form onSubmit={regSubmit}>
              ...
              <div>
                <label htmlFor="email_reg">Телефон:</label>
                <input
                  onChange={(e) => setValueTelReg(e.target.value)}
                  value={valueTelReg}
                  name="tel_reg"
